...
function SignUp() {
    ...
    return (
        <>
            ...
            <div className=" container m-auto  orderHeading  py-1 text-primary text-center">
                <h3>Please SignUp</h3>
            </div>
            <div className="container m-auto justify-content-center orderHeading  py-1 text-primary text-center ">
